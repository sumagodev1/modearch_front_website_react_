        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className="nav-link text-white" to="/completed_project">Projects</Link>
              </li>
              <li className="nav-item">
        ...
        <div className="container">
          <div className="row align-items-center justify-content-md-end">
            ...
            <div className="col-12 col-md-auto text-center text-md-end mb-2 mb-md-0 header-mail-number">
              ...
              <a href={`tel:+91${contacts[0]?.phone1 || "213-814-2277"}`} className="me-3 d-block d-md-inline" style={{ textDecoration: "none", color: "#000" }}>
